...
public class LevelBuilder<I, S> {
	...
	public void makeLvl(int levelID) {
		...
		if(levelID == 0) { // mainMenu
			...
			p.climbables.add(new LevelBlock<>(0, new Vertex(496.0,104.0), 99));
			p.climbables.add(new LevelBlock<>(0, new Vertex(496.0,120.0), 97));
			p.climbables.add(new LevelBlock<>(0, new Vertex(496.0,136.0), 97));
			p.climbables.add(new LevelBlock<>(0, new Vertex(496.0,152.0), 97));
			p.climbables.add(new LevelBlock<>(0, new Vertex(496.0,168.0), 97));
			p.climbables.add(new LevelBlock<>(0, new Vertex(496.0,184.0), 100));
			p.climbables.add(new LevelBlock<>(0, new Vertex(416.0,104.0), 99));
			p.climbables.add(new LevelBlock<>(0, new Vertex(416.0,120.0), 97));
			p.climbables.add(new LevelBlock<>(0, new Vertex(416.0,136.0), 100));
			...
			p.climbables.add(new LevelBlock<>(0, new Vertex(160.0,24.0), 97));
			p.climbables.add(new LevelBlock<>(0, new Vertex(160.0,40.0), 97));
			p.climbables.add(new LevelBlock<>(0, new Vertex(160.0,56.0), 97));
			p.climbables.add(new LevelBlock<>(0, new Vertex(160.0,72.0), 98));
			p.items.add(new Door<>(new Vertex(150, 246),() -> System.exit(0)));
			p.items.add(new Door<>(new Vertex(486, 54),() -> System.exit(0)));
			p.items.add(new Door<>(new Vertex(53, 62),() -> System.exit(0)));
