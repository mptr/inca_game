...
public class LevelBuilder<I, S> {
	...
	public void makeLvl(int levelID) {
		...
		if(levelID == 0) { // mainMenu
			...
			p.blocks.add(new LevelBlock<>(0, new Vertex(48.0,96.0), 87));
			...
			p.blocks.add(new LevelBlock<>(0, new Vertex(40.0,96.0), 91));
			...
			p.blocks.add(new LevelBlock<>(0, new Vertex(64.0,40.0), 20));
			p.blocks.add(new LevelBlock<>(0, new Vertex(96.0,40.0), 61));
			p.blocks.add(new LevelBlock<>(0, new Vertex(96.0,48.0), 63));
			p.blocks.add(new LevelBlock<>(0, new Vertex(40.0,48.0), 90));
			p.blocks.add(new LevelBlock<>(0, new Vertex(48.0,48.0), 86));
			p.blocks.add(new LevelBlock<>(0, new Vertex(48.0,56.0), 95));
			p.blocks.add(new LevelBlock<>(0, new Vertex(48.0,64.0), 94));
			p.blocks.add(new LevelBlock<>(0, new Vertex(48.0,72.0), 95));
			p.blocks.add(new LevelBlock<>(0, new Vertex(48.0,80.0), 95));
			p.blocks.add(new LevelBlock<>(0, new Vertex(48.0,88.0), 95));
			p.blocks.add(new LevelBlock<>(0, new Vertex(40.0,88.0), 83));
			p.blocks.add(new LevelBlock<>(0, new Vertex(40.0,80.0), 82));
			p.blocks.add(new LevelBlock<>(0, new Vertex(40.0,72.0), 82));
			p.blocks.add(new LevelBlock<>(0, new Vertex(40.0,56.0), 83));
			p.blocks.add(new LevelBlock<>(0, new Vertex(40.0,64.0), 82));
			p.blocks.add(new LevelBlock<>(0, new Vertex(56.0,48.0), 96));
			p.blocks.add(new LevelBlock<>(0, new Vertex(56.0,40.0), 93));
			p.blocks.add(new LevelBlock<>(0, new Vertex(32.0,40.0), 81));
			p.blocks.add(new LevelBlock<>(0, new Vertex(32.0,48.0), 84));
			p.blocks.add(new LevelBlock<>(0, new Vertex(40.0,40.0), 85));
			p.blocks.add(new LevelBlock<>(0, new Vertex(48.0,40.0), 85));
			p.background.add(new LevelBlock<>(2, new Vertex(192.0,16.0), 89));
			p.background.add(new LevelBlock<>(2, new Vertex(200.0,16.0), 89));
			p.background.add(new LevelBlock<>(2, new Vertex(208.0,16.0), 89));
			p.background.add(new LevelBlock<>(2, new Vertex(216.0,16.0), 89));
			p.background.add(new LevelBlock<>(2, new Vertex(224.0,16.0), 89));
			p.background.add(new LevelBlock<>(2, new Vertex(232.0,16.0), 89));
			p.background.add(new LevelBlock<>(2, new Vertex(240.0,16.0), 89));
			p.background.add(new LevelBlock<>(2, new Vertex(248.0,16.0), 89));
			p.background.add(new LevelBlock<>(2, new Vertex(256.0,16.0), 89));
			p.background.add(new LevelBlock<>(2, new Vertex(264.0,16.0), 89));
			p.background.add(new LevelBlock<>(2, new Vertex(272.0,16.0), 89));
			p.background.add(new LevelBlock<>(2, new Vertex(280.0,16.0), 93));
			p.background.add(new LevelBlock<>(2, new Vertex(280.0,24.0), 95));
			p.background.add(new LevelBlock<>(2, new Vertex(280.0,32.0), 95));
			p.background.add(new LevelBlock<>(2, new Vertex(280.0,40.0), 95));
			p.background.add(new LevelBlock<>(2, new Vertex(280.0,48.0), 95));
			p.background.add(new LevelBlock<>(2, new Vertex(280.0,56.0), 95));
			p.background.add(new LevelBlock<>(2, new Vertex(280.0,64.0), 95));
			p.background.add(new LevelBlock<>(2, new Vertex(280.0,72.0), 95));
			p.background.add(new LevelBlock<>(2, new Vertex(280.0,80.0), 95));
			p.background.add(new LevelBlock<>(2, new Vertex(280.0, 88.0), 96));
			p.background.add(new LevelBlock<>(2, new Vertex(272.0,104.0-16), 92));
			p.background.add(new LevelBlock<>(2, new Vertex(264.0,104.0-16), 92));
			p.background.add(new LevelBlock<>(2, new Vertex(256.0,104.0-16), 92));
			p.background.add(new LevelBlock<>(2, new Vertex(248.0,104.0-16), 92));
			p.background.add(new LevelBlock<>(2, new Vertex(240.0,104.0-16), 92));
			p.background.add(new LevelBlock<>(2, new Vertex(232.0,104.0-16), 92));
			p.background.add(new LevelBlock<>(2, new Vertex(224.0,104.0-16), 92));
			p.background.add(new LevelBlock<>(2, new Vertex(216.0,104.0-16), 92));
			p.background.add(new LevelBlock<>(2, new Vertex(208.0,104.0-16), 92));
			p.background.add(new LevelBlock<>(2, new Vertex(200.0,104.0-16), 92));
			p.background.add(new LevelBlock<>(2, new Vertex(192.0,104.0-16), 92));
			p.background.add(new LevelBlock<>(2, new Vertex(184.0,104.0-16), 84));
			p.background.add(new LevelBlock<>(2, new Vertex(184.0,80.0), 82));
			p.background.add(new LevelBlock<>(2, new Vertex(184.0,72.0), 82));
			p.background.add(new LevelBlock<>(2, new Vertex(184.0,64.0), 82));
			p.background.add(new LevelBlock<>(2, new Vertex(184.0,56.0), 82));
			p.background.add(new LevelBlock<>(2, new Vertex(184.0,48.0), 82));
			p.background.add(new LevelBlock<>(2, new Vertex(184.0,48.0), 83));
			p.background.add(new LevelBlock<>(2, new Vertex(184.0,40.0), 82));
			p.background.add(new LevelBlock<>(2, new Vertex(184.0,32.0), 82));
			p.background.add(new LevelBlock<>(2, new Vertex(184.0,24.0), 82));
			p.background.add(new LevelBlock<>(2, new Vertex(184.0,16.0), 81));
			p.otherObjs.add(new TextObject<>(new Vertex(625, 110),"STEUERUNG","Times New Roman Bold",25, new Color(0x355157), false));
			p.otherObjs.add(new TextObject<>(new Vertex(600, 125+30),"SHIFT","Times New Roman Bold",20, new Color(0x355157), false));
			p.otherObjs.add(new TextObject<>(new Vertex(600, 125+60),"A / D","Times New Roman Bold",20, new Color(0x355157), false));
			p.otherObjs.add(new TextObject<>(new Vertex(600, 125+90),"W / S","Times New Roman Bold",20, new Color(0x355157), false));
			p.otherObjs.add(new TextObject<>(new Vertex(600, 125+120),"SPACE","Times New Roman Bold",20, new Color(0x355157), false));
			p.otherObjs.add(new TextObject<>(new Vertex(680, 125+30),"Sprint","Times New Roman",20, new Color(0x355157), false));
			p.otherObjs.add(new TextObject<>(new Vertex(680, 125+60),"links / rechts","Times New Roman",20, new Color(0x355157), false));
			p.otherObjs.add(new TextObject<>(new Vertex(680, 125+90),"klettern / halten","Times New Roman",20, new Color(0x355157), false));
			p.otherObjs.add(new TextObject<>(new Vertex(680, 125+120),"(Doppel-) Sprung","Times New Roman",20, new Color(0x355157), false));
			p.items.add(new Door<>(new Vertex(150, 246),() -> p.resetLvl(1)));
			p.items.add(new Door<>(new Vertex(486, 54),() -> p.resetLvl(2)));
			p.items.add(new Door<>(new Vertex(63, 62),() -> System.exit(0)));
			p.otherObjs.add(new TextObject<>(new Vertex(1482, 104),"Level II","Times New Roman",20, new Color(0xE3A569), false));
			p.otherObjs.add(new TextObject<>(new Vertex(477, 704),"Level I","Times New Roman",20, new Color(0xE3A569), false));
			p.otherObjs.add(new TextObject<>(new Vertex(218, 152),"EXIT","Times New Roman",20, new Color(0xE3A569), false));
			p.player.getPos().moveTo(new Vertex(16*3+50,(SimpleGame.gameSize.y*16-16*2)*3-50));
		} else if(levelID == 1) { // lv 1
			// TODO remove signs, add coins & skellis for level1
			for (int i = 0; i < 3; i++) {
				p.background.add(new LevelBlock<>(2, new Vertex(1.5*16, 12.5*16 + 16 * (4-i)), 58-i));
				p.background.add(new LevelBlock<>(2, new Vertex(19*16, 12.5*16 + 16 * (4-i)), 58-i));
			}
			...
			p.blocks.add(new LevelBlock<>(0, new Vertex(40.0,40.0), 85));
			p.blocks.add(new LevelBlock<>(0, new Vertex(48.0,40.0), 85));
			p.items.add(new Door<>(new Vertex(502, 54),() -> p.resetLvl(0)));
			p.player.getPos().moveTo(new Vertex(16*3+50,(SimpleGame.gameSize.y*16-16*2)*3-50));
		} else {
			// TODO lvl2
		}
